...
//@interface TitaniumIntentTestObject : NSObject
//@end

@interface TitaniumIntentTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TitaniumIntentTestObject class]])
		{
			for (NSString *key in [[(TitaniumIntentTestObject*)o modules] allKeys])
			{
