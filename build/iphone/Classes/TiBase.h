...
// in simulator we redefine to format for TitaniumIntentTest Developer console
...
{\
	NSString * exceptionName = [@"org.titaniumintenttest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titaniumintenttest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITitaniumIntentTestNativeItemNone = -1, 
	UITitaniumIntentTestNativeItemSpinner = -2,
	UITitaniumIntentTestNativeItemProgressBar = -3,
	
	UITitaniumIntentTestNativeItemSlider = -4,
	UITitaniumIntentTestNativeItemSwitch = -5,
	UITitaniumIntentTestNativeItemMultiButton = -6,
	UITitaniumIntentTestNativeItemSegmented = -7,
	
	UITitaniumIntentTestNativeItemTextView = -8,
	UITitaniumIntentTestNativeItemTextField = -9,
	UITitaniumIntentTestNativeItemSearchBar = -10,
	
	UITitaniumIntentTestNativeItemPicker = -11,
	UITitaniumIntentTestNativeItemDatePicker = -12,
	
	UITitaniumIntentTestNativeItemInfoLight = -13,
	UITitaniumIntentTestNativeItemInfoDark = -14,
	
	UITitaniumIntentTestNativeItemDisclosure = -15,
	
	UITitaniumIntentTestNativeItemContactAdd = -16
};
